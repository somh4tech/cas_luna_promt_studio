...
-- Create a table for caching AI prompt analysis results
...
-- Create policy for users to insert their own prompt analyses
CREATE POLICY "Users can create their own prompt analyses" 
  ON public.prompt_ai_analysis 
  FOR INSERT 
  WITH CHECK (
    EXISTS (
